...
for j = 1: dimL2,
    ...
    % replace all small valued in w with 0
    temp = w(:,j);
...
% save as PNG and EPS
saveas(1, 'Sparsed_Regression_Classification_Error_SSE_vs_Regularization_Term_Lambda', 'epsc2');
saveas(1, 'Sparsed_Regression_Classification_Error_SSE_vs_Regularization_Term_Lambda', 'png');
saveas(1, 'Sparsed_Regression_Classification_Error_SSE_vs_Regularization_Term_Lambda', 'fig');
